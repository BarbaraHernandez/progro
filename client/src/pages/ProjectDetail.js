...
class ProjectDetail extends Component {
  ...
  loadProject = () => {
    API
      .getThisProject(this.props.match.params.id)
      .then(res => {
        this.setState({
          project: {
            id: res.data.id,
  ...
  loadMilestones = () => {
    API
      .getProjectMilestones(this.state.project.id)
      .then(res => {
        this.setState({
          milestones: res.data,
          newMilestone: ''
  ...
  loadRoles = () => {
    API.getRoles(this.state.project.id)
      ...
      .then(() => this.state.loading && this.loadRoleMembers())
      .catch(err => console.log(err));
  };
  ...
  createRoleMember = (roleId) => {
    ...
    API
      .postRoleMember(roleMember)
      .then(() => this.loadRoleMembers())
      .catch(err => console.log(err));
  };
